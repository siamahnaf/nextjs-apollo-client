    ...
    return (
        <div>
            <TableHeader
                ...
                path=""
                data={data?.getReviewByAdmin.results?.map(item => ({ id: item.id, name: item.product?.name, category: item.product?.category })) as any[]}
            ...
            <Table
                ...
                data={data?.getReviewByAdmin.results || []}
            ...
            <TablePagination
                meta={data?.getReviewByAdmin.meta}
