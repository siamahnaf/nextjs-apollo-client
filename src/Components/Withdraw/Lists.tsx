    ...
    return (
        <div className="mt-12">
            <TableHeader
                ...
                path=""
                data={data?.getWithdrawByAdmin.results?.map(item => ({ id: item.id })) as any[]}
                headers={["ID"]}
            ...
            <Table
                ...
                data={data?.getWithdrawByAdmin.results || []}
            ...
            <TablePagination
                meta={data?.getWithdrawByAdmin.meta}
